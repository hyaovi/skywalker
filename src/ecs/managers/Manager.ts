...
import {
  type IModelParams,
  MeshComponent,
  type meshParamsMapType,
} from "../components";
import { Entity } from "../entities";
import { globalLoader } from "../loaders";
import type { IPrimitiveParams, Object3DType } from "../sharedTypes";
...
class Manager extends Base {
  ...
  async createEntityWithParams<MeshType extends keyof meshParamsMapType>(
    type: MeshType,
    params: meshParamsMapType[MeshType],
  ): Promise<Entity> {
